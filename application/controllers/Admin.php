...
class Admin extends CI_Controller
{
	...
	function kategori_produk()
	{
		...
		$data['title'] = 'Kategori Produk - Toko Online';
	...
	function tambah_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Kategori Produk - Toko Online';
	...
	function edit_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Produk - Toko Online';
	...
	function tambah_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Produk - Toko Online';
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function rekening()
	{
		...
		$data['title'] = 'Rekening - Toko Online';
	...
	function tambah_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Rekening - Toko Online';
	...
	function edit_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Rekening - Toko Online';
	...
	function supplier()
	{
		...
		$data['title'] = 'Supplier - Toko Online';
	...
	function tambah_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Supplier - Toko Online';
	...
	function edit_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Supplier - Toko Online';
	...
	function konsumen()
	{
		$data['title'] = 'Konsumen - Toko Online';
	...
	function edit_konsumen()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Konsumen - Toko Online';
	...
	function detail_konsumen()
	{
		...
		$data['title'] = 'Detail Konsumen - Toko Online';
	...
	function pesanan_dikirim()
	{
		...
		$data['title'] = 'Masukan Resi - Toko Online';
	...
	function website()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Identitas Website - Toko Online';
	...
	function menu()
	{
		...
		$data['title'] = 'Menu Website - Toko Online';
	...
	function tambah_menu()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Menu Website - Toko Online';
	...
	function edit_menu()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Menu Website - Toko Online';
			$data['record'] = $this->model_menu->menu_utama();
	...
	function logo()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Logo Website - Toko Online';
	...
	function tambah_slider()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Slider - Toko Online';
	...
	function edit_slider()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Slider - Toko Online';
	...
	function halaman()
	{
		...
		$data['title'] = 'Halaman - Toko Online';
	...
	function tambah_halaman()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Halaman Baru - Toko Online';
	...
	function edit_halaman()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Halaman Baru - Toko Online';
	...
	function artikel()
	{
		$data['title'] = 'Artikel - Toko Online';
	...
	function tambah_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Artikel - Toko Online';
	...
	function edit_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Artikel - Toko Online';
			$data['tag'] = $this->model_artikel->tag_artikel();
			$data['record'] = $this->model_artikel->kategori_artikel();
	...
	function tambah_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Tag - Toko Online';
	...
	function edit_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Tag - Toko Online';
	...
	function edit_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Pengguna - Toko Online';
	...
	function users()
	{
		$data['title'] = 'Manajemen Pengguna - Toko Online';
	...
	function tambah_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Pengguna - Toko Online';
	...
	function laporan()
	{
		$data['title'] = 'Laporan Penjualan - Toko Online';
	...
	function newsletter()
	{
		...
		$data['title'] = 'Newsletter - Toko Online';
	...
	function tambah_newsletter()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$ci->email->from('demo-ecommerce@zamanet.com', "Toko Online");
			...
			$data['title'] = 'Kirim News Letter - Toko Online';
	...
	function lihat_newsletter()
	{
		...
		$data['title'] = 'Detail Berita - Toko Online';
	...
	function subscriber()
	{
		$data['title'] = 'Subscriber - Toko Online';
